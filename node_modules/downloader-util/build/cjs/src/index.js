...
exports.download = exports.DownLoad = void 0;
...
var download = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var startTime, endTime;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                startTime = Date.now();
                return [4 /*yield*/, new DownLoad_1.DownLoad(opts).start()];
            case 1:
                _a.sent();
