...
var TASK_POOL_STATUS;
(function (TASK_POOL_STATUS) {
    TASK_POOL_STATUS[TASK_POOL_STATUS["START"] = 0] = "START";
    TASK_POOL_STATUS[TASK_POOL_STATUS["STOP"] = 1] = "STOP";
})(TASK_POOL_STATUS || (TASK_POOL_STATUS = {}));
...
var TaskPool = /** @class */ (function () {
    function TaskPool(taskMaxNum, initTaskCount) {
        this.taskList = [];
        this.doningList = [];
        this.doneList = [];
    ...
    TaskPool.prototype.addTask = function (task) {
        if (this.status !== TASK_POOL_STATUS.START)
            return;
    ...
    TaskPool.prototype.doProgress = function (task) {
        if (this.status !== TASK_POOL_STATUS.START)
            return;
        var doneLen = this.doneList.length + this.initTaskCount;
